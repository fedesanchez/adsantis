...
<body>
    ...
    <!--Title / Beadcrumb-->
            <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
                <div class="bread-heading"><h1><?=($_SESSION['lang']=='en')?"Contact":"Contacto";?></h1></div>
                <div class="bread-crumb pull-right">
                <ul>
                <li><a href="index.php">Home</a></li>
                <li><a href="#"><?=($_SESSION['lang']=='en')?"Contact":"Contacto";?></a></li>
                </ul>
                </div>
            </div>
         </div>
                ...
                <div class="row">
                    ...
                    <div class="contact-widgets">
                        ...
                        <div class="contact-widget-box col-md-3 col-lg-3 col-sm-6 col-xs-12 wow bounceIn" data-wow-delay="0.5s" data-wow-offset="150">
                            ...
                            <div class="contact-widget-title"><?=($_SESSION['lang']=='en')?"Address":"Direccion";?></div>
                        ...
                        <div class="contact-widget-box col-md-3 col-lg-3 col-sm-6 col-xs-12 wow bounceIn" data-wow-delay="0.8s" data-wow-offset="150">
                            ...
                            <div class="contact-widget-title"><?=($_SESSION['lang']=='en')?"Phone":"Telefono";?></div>
                            <p>(011) 4301 8752</p>
                        </div>
         ...
         <div class="container">
            ...
            <div class="col-xs-12 col-lg-12  col-sm-12 col-md-12 pull-left contact2-wrap no-pad">
                ...
                <div class="col-xs-12 col-lg-12 col-sm-12 col-md-12 pull-left no-pad">
                    ...
                    <div class="subtitle col-xs-12 no-pad col-sm-12 col-md-12 pull-left news-sub icontact-widg"><?=($_SESSION['lang']=='en')?"Write us":"Escribinos";?></div>
                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad wow fadeInUp" data-wow-delay="0.5s" data-wow-offset="160">
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad">
                            ...
                            <div class="alert alert-success hidden" id="contactSuccess">
                                <strong>OK!</strong> <?=($_SESSION['lang']=='en')?"Message sent":"Su mensaje fue enviado.";?>
                            </div>

                            <div class="alert alert-error hidden" id="contactError">
                                <strong>Error!</strong> <?=($_SESSION['lang']=='en')?"problem found":"hubo un problema en su mensaje.";?>
                            </div>
                ...
                <form class="contact2-page-form col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad contact-v1" id="contactForm">
                            ...
                            <input type="text" class="contact2-textbox" placeholder=<?=($_SESSION['lang']=='en')?"Name*":"Nombre*";?> name="name" id="name" />
                            ...
                            <div class="col-lg-4 col-sm-12 col-md-4 col-xs-12 control-group">
                                ...
                                <input type="text" placeholder=<?=($_SESSION['lang']=='en')?"Issue*":"Asunto*";?> class="contact2-textbox" name="subject" id="subject">
                            </div>
                            
                            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            <textarea class="contact2-textarea" placeholder=<?=($_SESSION['lang']=='en')?"Message":"Mensaje";?> name="message" id="message"></textarea>
                            </div>
                            
                            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            
                            <section class="color-7" id="btn-click">
                <button class="icon-mail btn2-st2 btn-7 btn-7b"  data-loading-text="Loading..." type="submit"><?=($_SESSION['lang']=='en')?"Send":"Enviar";?></button>
