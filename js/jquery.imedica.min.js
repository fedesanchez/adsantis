$(document).ready(function(){$searchOverlay = $("#search-overlay");$hiddenSearch = $("#hidden-search");$("#search").click(function(){$searchOverlay.show();$hiddenSearch.focus();});
	$searchOverlay.click(function(event){$hiddenSearch.focus();if(event.target.id=="search-overlay"||event.target.id=="close"){$hiddenSearch.blur();
		$(this).animate({opacity:0},500,function(){$(this).hide().css("opacity",1);});}});
